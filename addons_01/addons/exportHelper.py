...
from my_addon_test import MyAddonOperator

# Add the necessary directories to the Python module search path
# sys.path.append(abspath(dirname(__file__)))
# sys.path.append(abspath(dirname(__file__)) + '/addons')
# sys.path.append(abspath(dirname(__file__)) + '/room')
...
class ExportGLTFWithCustomDataOperator(bpy.types.Operator, ExportHelper):
    ...
    def execute(self, context):
        ...
        # print(MyAddonOperator)
        test_01=MyAddonOperator.execute(self,context)
        print("---------------------------------------")
        print(test_01)
        ...
        test_01=json.loads(test_01)
        
        gltf_data['extras'] = test_01
